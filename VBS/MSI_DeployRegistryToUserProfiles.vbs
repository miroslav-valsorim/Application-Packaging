...
'*			The script works with input reg file, pre-deployed by the msi to INSTALLDIR									*
...
strInputRegFileName = "CurrentUserWindowPopUp.reg"
...
Function ApplyRegistryToProfiles()
	...
	strMSIPath = Session.Property("INSTALLDIR")
